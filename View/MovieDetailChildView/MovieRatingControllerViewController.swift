//
//  MovieRatingControllerViewController.swift
//  MoviesApp
//
...
class MovieRatingControllerViewController: UIViewController {
    ...
    let ratingLable: UILabel = {
        let ratingLable = UILabel()
        ratingLable.font = AppFont.regularPoppin32
        ratingLable.textColor = UIColor(red: 78/255, green: 75/255, blue: 102/255, alpha: 1)
    ...
    @objc func sliderValueChanged(_ sender: UISlider) {
        ratingLable.text = String(format: "%.2f", sender.value)
    }
    ...
    func configureUi() {
        ...
        sheetView.addSubview(ratingLable)
    ...
    func setUpConstrains(){
        NSLayoutConstraint.activate([
            ...
            ratingLable.bottomAnchor.constraint(equalTo: ratingSlider.topAnchor, constant: -20),
            ratingLable.centerXAnchor.constraint(equalTo: sheetView.centerXAnchor),
            
            sheetTitle.bottomAnchor.constraint(equalTo: ratingLable.topAnchor, constant: -25),
        ...
        ratingLable.text = String(ratingSlider.value)
    }
